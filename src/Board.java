...
public class Board extends JComponent {
    ...
    private static final Color colorPlayer2 = new Color(255, 165, 0);
    private static final Color colorPlayer1 = new Color(122, 197, 205);
    ...
    private void printStatusMessage(Graphics g2D, String message){
        try {
            g2D.setFont(Font.createFont(Font.TRUETYPE_FONT, new File("/Users/kevin/Downloads/Goldman/Goldman-Regular.ttf")).deriveFont(Font.PLAIN, 40));
        } catch (Exception ex) {
            ex.printStackTrace();
